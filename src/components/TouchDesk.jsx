...
import Banner from '../assets/front-what-we-do-link.png';
import Navigation from '../components/Navigation';
import navTouch from '../assets/nav-touch-ps.png';
...
function Touch() {
  ...
  <Link to="/HomeView"> <img className="img_1" src={Back}  /></Link> 
    <Link to="/TouchView"><img className="img_1" src={navTouch}/></Link>
   ...
   <Link to="/AboutView"> <img className="img_1" src={nav_3}/></Link>
      ...
      <Col className="col-lg-3 col-md-3  offset-1">
          ...
          <Col className="col-lg-8 col-sm-8">
              ...
              <h1 fluid className="h1_top">Design is the <span className="span_blue">matter of choise</span>...</h1>
            ...
            <div className="div_what">What We Do</div>
          </Col>
      </Row>
    </Container>
